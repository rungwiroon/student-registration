      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative">
          ...
          <div class="space-y-3">
            ...
            <p><span class="text-gray-500 text-sm">ห้องเดิม:</span> <span class="font-medium ml-2">{{ detail.student.oldRoom }} เลขที่ {{ detail.student.oldNo }}</span></p>
          ...
          <div class="mt-6 pt-4 border-t border-gray-100">
            <div class="flex justify-between items-center mb-2">
              ...
              <button v-if="!isEditingNote" @click="isEditingNote = true; newNote = detail.student.internalNote || ''" class="text-xs text-blue-600 hover:underline">✏️ แก้ไข</button>
            </div>
